    ...
    <header className="bg-card cyber-border p-4 relative">
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          <div className="text-2xl font-cyber cyber-glow-primary">
            ╔═══════════════════════════════════════════════════════╗
          </div>
        </div>
        <div className="text-center flex-1">
          <h1 className={`text-4xl font-cyber cyber-glow-primary ${glitch ? 'glitch' : ''}`}>
          ...
          <div className="mt-2 flex items-center justify-center gap-2">
            <span className="text-[10px] font-mono text-cyber-purple/70 uppercase tracking-wider">CA:</span>
            <div className="group relative inline-flex items-center gap-1.5 bg-cyber-purple/5 border border-cyber-purple/20 rounded px-3 py-1 hover:border-cyber-purple/40 transition-all">
              <code 
              ...
              {isAddressAvailable && (
                <Button
                  size="sm"
                  variant="ghost"
                  className="h-5 w-5 p-0 hover:bg-cyber-purple/20 opacity-70 hover:opacity-100 transition-opacity"
                ...
                >
                  {copied ? (
                    ...
                    <Copy className="h-3 w-3 text-cyber-purple" />
                  )}
                </Button>
              )}
              {/* Tooltip on hover showing full address */}
              {isAddressAvailable && (
                <div className="absolute top-full left-1/2 -translate-x-1/2 mt-2 px-3 py-2 bg-black/95 border border-cyber-purple/40 rounded text-[10px] font-mono text-cyber-purple whitespace-nowrap opacity-0 group-hover:opacity-100 pointer-events-none transition-opacity z-50">
                  {contractAddress}
                </div>
              )}
            </div>
